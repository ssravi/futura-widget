  ...
  <body>
        ...
        <section class="popupBody">
          ...
          <div class="user_login">
            <form method="post" action="" id="userlogin">
              <label>Email / Username</label>
				<input type="text" required="required" placeholder="username"  title="Please enter your username (at least 3 characters)"  name="uname" id="uname" class="in-text"/>
              <br />

              <label>Password</label>
             <input type="password" required="required" placeholder="password"  title="Please enter your password, between 5 and 12 characters"  name="password" id="password" class="in-text"/>
              <br />
				<div class="error"></div>
          ...
          <div class="user_register">
            <form method="post" action="" id="user-rgister">
              ...
              <input required="required" type="text" title="Please Enter First name" name="first_name" title="First name" placeholder="Firstname"/>

              <label>Last Name</label>
              <input required="required" type="text" placeholder="Last Name" name="last_name" title="Please Enter Last name"/>

              <label>Primary Email</label>
              <input required="required" type="email" name="primary_email" placeholder="Primary Email" title="Please Enter Valid Email Address" />

              <label>University Email</label>
              <input required="required" type="email" name="university_email" placeholder="University Email" title="Please Enter Correct University Email Address" />

              <label>Choose Degree</label>
              <select required="required" name="degree" title="Please Choose Degree">
              ...
              <select required="required" name="year" title="Please Choose Year of Graduation.">
              <option value="" selected="selected">-- Select an option --</option>
              <?php 
              $year = 1950;
              for($i = $year;$i <= 2020;$i++){ ?>
              ...
              <select required="required" name="major" title="Please Choose Major.">
              <option value="" selected="selected">-- Select an option --</option>
              ...
              <input required="required" type="text" name="phone_field" placeholder="Phone Number" title="Please Enter Valid Phone number" />

              <label>Password</label>
              <input required="required" type="password" id="password" placeholder="Password" title="Please Enter Password" name="password"/>
              <label>Handle</label>
              <input required="required" type="text" name="handle" placeholder="Handle" title="Please Enter Handle" />
    ...
    <script type="text/javascript">
      $("#modal_trigger").leanModal({top: 20, overlay: 0.6, closeButton: ".modal_close"});
		$("#userlogin").validate({
			errorLabelContainer: $("#userlogin div.error")
		});
		$("#user-rgister").validate({
			errorLabelContainer: $("#user-rgister div.error")
		});
